...
namespace jobagapi.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Employer>().Property(p => p.FirstName).IsRequired().HasMaxLength(30);
            builder.Entity<Employer>().Property(p => p.LastName).IsRequired().HasMaxLength(30);
            builder.Entity<Employer>().Property(p => p.Email).IsRequired().HasMaxLength(30);
            builder.Entity<Employer>().Property(p => p.PhoneNumber).IsRequired();
            builder.Entity<Employer>().Property(p => p.PassWord).IsRequired().HasMaxLength(30);
            builder.Entity<Employer>().Property(p => p.Position).IsRequired().HasMaxLength(30);
